...
test("库存查询日期必须同时填写，且结束日期不能早于开始日期", () => {
  ...
  assert.throws(() => createStockQueryRange("2026-02-31", "2026-03-01"), /日期格式无效/);
  assert.throws(() => createStockQueryRange("2026-13-01", "2026-13-02"), /日期格式无效/);
  assert.throws(() => createStockQueryRange("2026-00-01", "2026-01-01"), /日期格式无效/);
});
